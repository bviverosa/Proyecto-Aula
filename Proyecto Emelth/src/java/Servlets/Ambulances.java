...
public class Ambulances extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String service = request.getParameter("service");
                int institutionOption,serviceOption;
         switch(institution){
             case "10":
                 institutionOption=1;
    ...
    private boolean insertIntoDatabase(String plateNumber, int institution,int  service) {
           try {
            ...
            String sql = "INSERT INTO tabla_ambulancias (am_placa, Institucion_ins_id, Servicio_se_id) VALUES (?, ?, ?)";
